...
<div class="Menu">
    <div class="wrap">
        <div class="nav">
            <ul class="nav-list">
                <li class="nav-item">
                    <a href="javascript:;" class="item-category">手机 电话卡</a>
                    <div class="children">
                        <ul>
                            <li>
                ...
                <li class="nav-item">
                    <a href="#" class="item-category">电视 盒子</a>
                    <div class="children">
                        <ul>
                            <li>
                                <a href="#" class="product-item">
                ...
                <li class="nav-item">
                    <a href="#" class="item-category">笔记本 平板</a>
        ...
        <div class="ad">
            <ul>
                <li v-for="ad in adList" :key="ad.id" class="item">
                    <a href="javascript:;">
                        <img :src="ad.img" alt="">
                    </a>
                </li>
